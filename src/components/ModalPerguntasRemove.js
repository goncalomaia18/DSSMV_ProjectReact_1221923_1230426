...
const ModalPerguntas = ({ visible, perguntas, onClose, onDelete, onSelectPergunta, selecionada }) => {
    return (
        <Modal visible={visible} animationType="slide" transparent>
            <View style={styles.modalContainer}>
                <View style={styles.modalContent}>
                    <Text style={styles.title}>Selecione uma pergunta para remover</Text>
                    <FlatList
                        data={perguntas}
                        ...
                        renderItem={({ item }) => (
                            <TouchableOpacity
                                ...
                                onPress={() => onSelectPergunta(item)}
                            >
                                <Text>{item.perguntaspersonalizado}</Text>
                            </TouchableOpacity>
                        )}
                    />
